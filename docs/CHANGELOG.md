...
Records updates to the `docs/` folder. New entries are appended at the bottom.

**Sources used:**
- `code.claude.com/docs/en/*.md` (Claude Code CLI documentation)
- `platform.claude.com/docs/en/**/*.md` (Platform/API documentation)

---

## 2026-01-12: Hooks, Memory, Settings (Core Configuration)

### 02-hooks.md — Updated

**Before:** ~218 lines | **After:** ~770 lines
...
### 07-claude-md-best-practices.md — Updated

**Before:** ~291 lines | **After:** ~468 lines
...
### 05-settings-reference.md — Updated

**Before:** ~314 lines | **After:** ~593 lines
...
## 2026-01-12: Subagents, Commands, Plugins (Extensibility)

### 09-subagents.md — Created
...
### 06-plugins.md — Updated

**Before:** ~190 lines | **After:** ~727 lines
...
## 2026-01-12: MCP, Headless, GitHub Actions, Checkpointing (Advanced Features)
...
## 2026-01-12: CLI, Interactive Mode, Output Styles, Model Config, Statusline (UI & CLI)

### 12-cli-reference.md — Created
...
### 16-interactive-mode.md — Created
...
### 18-model-configuration.md — Created
...
## 2026-01-12: Agent SDK

### 20-agent-sdk.md — Created
...
## 2026-01-12: Prompt Engineering

### 21-prompt-engineering.md — Created
...
## 2026-01-12: Troubleshooting, Testing & Evaluation (Final Polish)

### 22-troubleshooting.md — Created
...
### 23-testing-evaluation.md — Created
...
<!--
TEMPLATE FOR FUTURE ENTRIES (append below this line):
...
**Lines:** ~XXX (or Before/After for updates)

Sub-tasks completed:
- [x] What was added/changed
- [x] Another change
-->
